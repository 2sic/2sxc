...
namespace ToSic.SexyContent.WebApi
{
    ...
    public abstract class SxcApiController : DnnApiControllerWithFixes, IAppAndDataHelpers
    {
        ...
        protected override void Initialize(HttpControllerContext controllerContext)
        {
            ...
            Log.Rename("2sApiC");
            SxcContext = Helpers.GetSxcOfApiRequest(Request, true);
            AppAndDataHelpers = new AppAndDataHelpers(SxcContext, SxcContext?.ModuleInfo);
        ...
        public App App
        {
            get
            {
                ...
                return _app = (App) Environment.Dnn7.Factory.App(appId, new Environment.Dnn7.PagePublishing(Log).IsVersioningEnabled(Dnn.Module.ModuleID));
            }
        }
        private App _app;
