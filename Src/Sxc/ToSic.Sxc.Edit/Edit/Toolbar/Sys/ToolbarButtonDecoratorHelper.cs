...
public class ToolbarButtonDecoratorHelper(IAppReaderFactory appReaders, ScopedCache<Dictionary<string, ToolbarButtonDecorator?>> cache) : ServiceBase($"{SxcLogName}.TbdHlp")
{
