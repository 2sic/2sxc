...
public class AdamPrefetchHelper<TFolderId, TFileId>(AdamWorkBase<TFolderId, TFileId>.MyServices services, Generator<AdamItemDtoMaker<TFolderId, TFileId>, AdamItemDtoMakerOptions> dtoMaker)
        ...
        IAdamPrefetchHelper
{
    public IList<AdamItemDto> GetAdamItemsForPrefetch(string subFolderName, bool autoCreate = true)
    {
        ...
        var maker = dtoMaker.New(new() { AdamContext = AdamContext, });
