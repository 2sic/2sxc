...
namespace ToSic.Sxc.WebApi.Admin.Query
{
    public class QueryControllerReal: QueryControllerBase<QueryControllerReal>
    {
        ...
        public QueryControllerReal(QueryControllerDependencies services, LazySvc<CmsManager> cmsManagerLazy, IAppStates appStates, IContextResolver contextResolver, AppConfigDelegate appConfigMaker) 
