    ...
    ICanDebug
{
    ...
    /// * Changed type to `object` in v20 since we believe all use cases in the wild always use dynamic access, but we prefer to mark it as object to see if anything breaks
    /// </remarks>
    object Metadata { get; }
