...
public class PolymorphConfigReader(LazySvc<ServiceSwitcher<IPolymorphismResolver>> resolvers, LazySvc<IHttp> http)
    : ServiceBase("Plm.Managr", connect: [resolvers ])
{
    public PolymorphismConfigurationModel Configuration = null!;
    private int _appId;
    ...
    {
        Configuration = list.FirstModel<PolymorphismConfigurationModel>(
