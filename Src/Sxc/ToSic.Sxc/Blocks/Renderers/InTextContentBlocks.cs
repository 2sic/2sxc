...
namespace ToSic.Sxc.Blocks.Renderers
{
    internal class InTextContentBlocks
    {
        ...
        internal static string Render(DynamicEntity parent, string entityField, string textTemplate, IInPageEditingSystem edit, Generator<BlockFromEntity> blkFrmEntGen)
        {
            // do basic checking
