...
internal class DataClassGenerator(DataModelGenerator dmg, IContentType type, string className, string edition): HelperBase(dmg.Log, "Gen.DtaCls")
{
    #region Class
    ...
    internal CodeFileRaw PrepareFile()
    {
        ...
        var autoGenClassName = className + DataModelGenerator.AutoGeneratedSuffix;
    ...
    public string MainClassComment(string firstPropertyName) =>
        dmg.CodeGenHelper.CodeComment(DataModelGenerator.DepthClass,
            $"""
             This is a generated class for {className}
             To extend/modify it, see instructions above.
             """)
        + dmg.CodeGenHelper.XmlComment(DataModelGenerator.DepthClass, summary:
            $"""
    ...
    public string AutoGenClassComment() => 
        dmg.CodeGenHelper.XmlComment(DataModelGenerator.DepthClass, summary: $"Auto-Generated base class for {className}.");
