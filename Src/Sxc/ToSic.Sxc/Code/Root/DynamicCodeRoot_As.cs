...
namespace ToSic.Sxc.Code
{
    public partial class DynamicCodeRoot
    {
        ...
        /// <inheritdoc />
        public dynamic AsDynamic(string json, string fallback = default) => AsC.AsDynamicFromJson(json, fallback); // DynamicJacket.AsDynamicJacket(json, fallback, Log);

        /// <inheritdoc />
        public dynamic AsDynamic(IEntity entity) => AsC.AsDynamic(entity); // new DynamicEntity(entity, DynamicEntityServices);

        //internal DynamicEntity.MyServices DynamicEntityServices => AsC.DynamicEntityServices;
        ...
        //{
        //    var l = Log.Fn<object>();
        //    var typed = AsC.AsTypedInternal(dynObject);
        ...
        //private ITypedThing AsTypedInternal(object dynObject)
        //{
        //    var l = Log.Fn<ITypedThing>();
        //    switch (dynObject)
        //    {
        //        case null:
        //            return l.Return(AsC.AsDynamicFromJson(null), "null");
        //        case string strObject:
        //            return l.Return(AsC.AsDynamicFromJson(strObject), "string");
        //        case IDynamicEntity dynEnt:
        ...
        //    if (entities.Length == 1) return AsC.AsDynamicInternal(entities[0]);

        //    return AsC.MergeTyped(entities);
        ...
        //{
        //    if (entities == null || !entities.Any()) return null;
        //    if (entities.Length == 1) return AsC.AsTypedInternal(entities[0]);
        //    // New case: many items found, must create a stack
        //    var sources = entities
        //        .Select(e => e as IPropertyLookup)
        //        .Where(e => e != null)
        ...
        /// <inheritdoc />
        public IEntity AsEntity(object dynamicEntity) => AsC.AsEntity(dynamicEntity); // ((ICanBeEntity)dynamicEntity).Entity;
        ...
        /// <inheritdoc />
        public IFolder AsAdam(ICanBeEntity item, string fieldName) => AsC.Folder(item, fieldName); // DynamicEntityServices.AdamManager.Folder(item.Entity, fieldName);
