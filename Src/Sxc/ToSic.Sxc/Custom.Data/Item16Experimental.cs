...
public abstract class Item16Experimental(ITypedItem item, NoParamOrder protector = default, ServiceKit16 kit = default): ICanBeEntity, ITypedItem, ITypedItemWrapper16
{
    /// <summary>
    /// Empty constructor for use in auto-created objects
    /// </summary>
    protected Item16Experimental() : this(null) { }
