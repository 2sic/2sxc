...
partial class CustomModel : IMultiWrapper<IEntity>
{
    ...
    public static bool operator ==(CustomModel item1, CustomModel item2) => MultiWrapperEquality.IsEqual(item1, item2);
