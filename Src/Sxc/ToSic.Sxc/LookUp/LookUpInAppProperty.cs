    ...
    internal class LookUpInAppProperty : LookUpBase
    {
        ...
        private ILookUp Settings
        {
            get
            {
                ...
                return _settings = new LookUpInEntity("appsettings", dynEnt?.Entity, dynEnt?._Cdf.Dimensions);
            }
        }
        ...
        private ILookUp Resources
        {
            get
            {
                ...
                return _resources = new LookUpInEntity("appresources", dynEnt?.Entity, dynEnt?._Cdf.Dimensions);
            }
        }
