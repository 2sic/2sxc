...
namespace ToSic.Sxc.Web.PageService
{
    public partial class PageService
    {
        ...
        public IHybridHtmlString AssetAttributes(string noParamOrder = Eav.Parameters.Protector, bool optimize = true, int priority = 0, string position = null, bool whitelist = true)
        {
            ...
            return new HybridHtmlString(result);
        }
