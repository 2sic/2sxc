...
namespace ToSic.Sxc.Adam
{
    public class AdamManager<TFolderId, TFileId>: AdamManager
    {
        ...
        public AdamManager(LazyInit<AppRuntime> appRuntime, Lazy<AdamMetadataMaker> metadataMaker, AdamConfiguration adamConfiguration, LazyInit<IAdamFileSystem<TFolderId, TFileId>> adamFsLazy)
