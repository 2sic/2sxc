...
public interface IAssetsExtractor: IHasLog
{
    OutputFragmentWithAssets Process(string html);
    ...
    /// </returns>
    OutputFragmentWithAssets Process(string html, ClientAssetsExtractSettings settings);

    OutputFragmentWithAssets Process(OutputFragment resultRaw);
}