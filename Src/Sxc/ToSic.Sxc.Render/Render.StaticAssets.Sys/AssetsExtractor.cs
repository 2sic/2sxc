...
public abstract partial class AssetsExtractor(IPageServiceShared pageServiceShared)
    : ServiceBase("Sxc.AstOpt"), IAssetsExtractor
{
    /// <summary>
    ...
    public OutputFragmentWithAssets Process(string html)
        => Process(html, DefaultSettings);

    public OutputFragmentWithAssets Process(OutputFragment resultRaw)
    {
    ...
    /// </summary>
    /// <returns></returns>
    public OutputFragmentWithAssets Process(string html, ClientAssetsExtractSettings settings)
    {
