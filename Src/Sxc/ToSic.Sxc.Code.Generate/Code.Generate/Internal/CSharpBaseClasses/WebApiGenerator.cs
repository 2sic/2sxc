...
public class WebApiGenerator(IUser user, IAppStates appStates)
    : CSharpServicesGenerator(user, appStates), IFileGenerator
{
    ...
    public new string DescriptionHtml => $"EXPERIMENTAL The {Name} will generate <code>ControllerBase.Generated.cs</code> files in the <code>AppCode/Api</code> folder. <br> IMPORTANT: Requires that Content-Types were generated.";

    public new string OutputType => "RazorView";// "CSharpService";
