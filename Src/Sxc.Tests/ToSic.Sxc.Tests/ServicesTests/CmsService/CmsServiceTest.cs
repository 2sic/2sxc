...
namespace ToSic.Sxc.Tests.ServicesTests.CmsService
{
    ...
    public class CmsServiceTest : CmsServiceTestBase
    {
        ...
        public void GetFactor(string classAttribute, string expectedFactor) => AreEqual(expectedFactor, Services.CmsService.CmsService.GetImgServiceResizeFactor(classAttribute));
