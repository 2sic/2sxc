...
public class WrapAllKeys : DynAndTypedTestsBase
{
    ...
    /// </summary>
    public static List<PropInfo> BoolKeys =
    [
    ...
    [TestMethod]
    public void KeysCountOnlySpecific1() => AreEqual(1, KeysDataObjJsonTyped.TestKeys(only: ["Key1"]).Count());

    [TestMethod]
    public void KeysCountOnlySpecific2() => AreEqual(2, KeysDataObjJsonTyped.TestKeys(only: ["Key1", "Key2"]).Count());

    [TestMethod]
    public void KeysCountOnlySpecific1of2() => AreEqual(1, KeysDataObjJsonTyped.TestKeys(only: ["Key1", "KeyNonExisting"
    ]).Count());

    [TestMethod]
    public void KeysCountOnlySpecific0() => AreEqual(0, KeysDataObjJsonTyped.TestKeys(only: ["Nonexisting"]).Count());
