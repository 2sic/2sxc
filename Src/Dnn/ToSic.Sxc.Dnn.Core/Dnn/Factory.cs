...
#pragma warning restore CS0618
        ...
        {
            DnnStaticDi.CodeChanges.Warn(V13To17($"ToSic.Sxc.Dnn.Factory.{nameof(CmsBlock)}", "https://go.2sxc.org/brc-13-dnn-factory"));
        ...
        {
            DnnStaticDi.CodeChanges.Warn(V13To17($"ToSic.Sxc.Dnn.Factory.{nameof(DynamicCode)}", "https://go.2sxc.org/brc-13-dnn-factory"));
        ...
        private static IApp App(
            ...
            ILog parentLog)
        {
            DnnStaticDi.CodeChanges.Warn(V13To17($"ToSic.Sxc.Dnn.Factory.{nameof(App)}", "https://go.2sxc.org/brc-13-dnn-factory"));
