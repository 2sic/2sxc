...
#pragma warning restore CS0618
        ...
        {
            Compatibility.Obsolete.Warning13To15($"ToSic.Sxc.Dnn.Factory.{nameof(CmsBlock)}", "", "https://go.2sxc.org/brc-13-dnn-factory");
        ...
        {
            Compatibility.Obsolete.Warning13To15($"ToSic.Sxc.Dnn.Factory.{nameof(DynamicCode)}", "", "https://go.2sxc.org/brc-13-dnn-factory");
        ...
        private static IApp App(
            ...
            ILog parentLog)
        {
            Compatibility.Obsolete.Warning13To15($"ToSic.Sxc.Dnn.Factory.{nameof(App)}", "", "https://go.2sxc.org/brc-13-dnn-factory");
