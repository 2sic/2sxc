...
namespace ToSic.Sxc.Dnn.Install
{
    public partial class DnnEnvironmentInstaller
    {
        ...
        // Note 2023-01-09 2dm - I refactored this to not use a static accessor
        // Should probably be fine, if all works well, remove ca. Feb 2023
        ...
        //    _upgradeComplete = VerifyUpgradeComplete();
        //}

//        private static bool VerifyUpgradeComplete()
//        {
//            // When this is created, update the status
//#pragma warning disable CS0618
//            var complete = DnnStaticDi.StaticBuild<DnnEnvironmentInstaller>()
