...
namespace ToSic.Sxc.WebApi.Cms
{
    public partial class UiController
    {
        ...
        public AllInOne Load([FromBody] List<ItemIdentifier> items, int appId)
        {
            ...
            //result.InputTypes = UiBackend.GetNecessaryInputTypes(result.ContentTypes, typeRead);
            ...
            //        PortalSettings, ActiveModule, UserInfo).InitApp(
        ...
        //    else
        //    {
        //        ent = jsonSerializer.ToJson(UiBackend.ConstructEmptyEntity(appId, bundle.Header, typeRead));
