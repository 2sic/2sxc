...
/***/ "./projects/edit/assets/icons/font-awesome/map-marker-alt-solid.svg":
/*!**************************************************************************!*\
  !*** ./projects/edit/assets/icons/font-awesome/map-marker-alt-solid.svg ***!
  \**************************************************************************/
...
var FieldCustomGpsDialog = /** @class */ (function (_super) {
    ...
    function FieldCustomGpsDialog() {
        var _this = _super.call(this) || this;
        _this.mapApiUrl = constants_1.mapsParameters.mapApiUrl;
        webpack_console_log_helper_1.webpackConsoleLog('FieldCustomGpsDialog constructor called');
    ...
    FieldCustomGpsDialog.prototype.connectedCallback = function () {
        var _this = this;
        webpack_console_log_helper_1.webpackConsoleLog('FieldCustomGpsDialog connectedCallback called');
        ...
        this.addressMaskService = new field_mask_service_1.FieldMaskService(addressMask, this.connector._experimental.formGroup.controls, null, null);
        webpack_console_log_helper_1.webpackConsoleLog('FieldCustomGpsDialog addressMask:', addressMask);
        if (addressMask) {
    ...
    FieldCustomGpsDialog.prototype.mapScriptLoaded = function () {
        webpack_console_log_helper_1.webpackConsoleLog('FieldCustomGpsDialog mapScriptLoaded called');
        ...
        this.subscription.add(this.connector.data.forceConnectorSave$.subscribe(onLatLngInputChangeBound));
    };
    ...
    FieldCustomGpsDialog.prototype.onLatLngInputChange = function () {
        webpack_console_log_helper_1.webpackConsoleLog('FieldCustomGpsDialog input changed');
        var latLng = {
    ...
    FieldCustomGpsDialog.prototype.autoSelect = function () {
        var _this = this;
        webpack_console_log_helper_1.webpackConsoleLog('FieldCustomGpsDialog geocoder called');
    ...
    FieldCustomGpsDialog.prototype.onMarkerDragend = function (event) {
        webpack_console_log_helper_1.webpackConsoleLog('FieldCustomGpsDialog marker changed');
        var latLng = {
    ...
    FieldCustomGpsDialog.prototype.disconnectedCallback = function () {
        webpack_console_log_helper_1.webpackConsoleLog('FieldCustomGpsDialog disconnectedCallback called');
        if (!!window.google) {
...
var FieldCustomGps = /** @class */ (function (_super) {
    ...
    function FieldCustomGps() {
        var _this = _super.call(this) || this;
        webpack_console_log_helper_1.webpackConsoleLog('FieldCustomGps constructor called');
        return _this;
    }
    FieldCustomGps.prototype.connectedCallback = function () {
        var _this = this;
        webpack_console_log_helper_1.webpackConsoleLog('FieldCustomGps connectedCallback called');
        this.innerHTML = helpers_1.buildTemplate(template.default, styles.default);
        ...
        this.eventListeners = [];
        var expandBound = this.expand.bind(this);
    ...
    FieldCustomGps.prototype.disconnectedCallback = function () {
        webpack_console_log_helper_1.webpackConsoleLog('FieldCustomGps disconnectedCallback called');
        this.eventListeners.forEach(function (evListener) {
...
var mapMarker = __webpack_require__(/*! ../../../edit/assets/icons/font-awesome/map-marker-alt-solid.svg */ "./projects/edit/assets/icons/font-awesome/map-marker-alt-solid.svg");
...
var FieldMaskService = /** @class */ (function () {
    function FieldMaskService(mask, model, changeEvent, overloadPreCleanValues, eavConfig) {
