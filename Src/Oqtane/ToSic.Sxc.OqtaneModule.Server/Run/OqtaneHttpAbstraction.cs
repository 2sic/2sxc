...
#else
        public OqtaneHttpAbstraction(IHttpContextAccessor contextAccessor, IHostingEnvironment hostingEnvironment, IUrlHelperFactory urlHelperFactory, IActionContextAccessor actionContextAccessor)
        {
