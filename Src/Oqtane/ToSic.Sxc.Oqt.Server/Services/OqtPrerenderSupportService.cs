...
{
    public class OqtPrerenderSupportService : IOqtPrerenderSupportService
    {
        private readonly IHttpContextAccessor _httpContextAccessor;

        public OqtPrerenderSupportService(IHttpContextAccessor httpContextAccessor)
        {
            _httpContextAccessor = httpContextAccessor;
        }

        public bool Executed // for execution once per request
        {
        ...
        public bool HasUserAgentSignature()
        {
