...
namespace ToSic.Sxc.Oqt.Server.Run
{
    public partial class OqtState
    {
        ...
        private T GetRouteValuesString<T>(string key, T fallback)
        {
            ...
            var valueString = _httpContextAccessor.HttpContext?.Request.RouteValues[key] ?? null;
            if (valueString == null || valueString == StringValues.Empty) return fallback;
