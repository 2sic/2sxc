...
{
    /// <summary>
    /// Ensure standard assets like java-scripts and styles for SSR.
    /// </summary>
    ...
    public string AttachScriptsAndStylesForStaticSsrFirstLoad(OqtViewResultsDto viewResults, SiteState siteState, string content, string themeName)
    {
    ...
    public string AttachScriptsAndStylesForStaticSsrPartialLoad(OqtViewResultsDto viewResults, SiteState siteState, string content, string themeName)
    {
