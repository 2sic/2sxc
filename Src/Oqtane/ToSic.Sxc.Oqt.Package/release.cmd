@ECHO off
SET Source=%1
SET OqtaneModuleInstallPackages=%2
ECHO Source=%Source%
ECHO OqtaneModuleInstallPackages=%OqtaneModuleInstallPackages%
...
SET "NormalizedPath=!OqtaneModuleInstallPackages:/=\!"
XCOPY "*.nupkg" "%NormalizedPath%" /Y
