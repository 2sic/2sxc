...
namespace ToSic.Sxc.Apps.Blocks
{
    ...
    //        if (somethingChanged)
    //            SaveItemLists(this, package);
    //    }

        //private static void SaveItemLists(BlockConfiguration block, Dictionary<string, List<int?>> values)
        //{
        ...
        //    var saveEnt = new EntitySaver(block.Log).CreateMergedForSaving(block.Entity, newEnt, saveOpts);
        ...
        //    var cms = new CmsManager(block.ZoneId, block.AppId, block.ShowDrafts, block.VersioningEnabled, block.Log);
        ...
        //    SaveItemLists(this,PrepareSavePackage(type, list1, PrepareSavePackage(type2, list2)));
        //}
        ...
        //    SaveItemLists(this,PrepareSavePackage(ViewParts.Content, list1, PrepareSavePackage(ViewParts.Presentation, list2)));
