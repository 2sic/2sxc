...
angular.module("eavFieldTemplates")
    ...
    .controller("FieldTemplate-EntityQueryCtrl", ["$controller", "$scope", "fieldMask", "$q", "query", "$timeout", "$translate", function ($controller, $scope, fieldMask, $q, query, $timeout, $translate) {
