...
var ContentListActions = /** @class */ (function () {
    ...
    ContentListActions.prototype.addItem = function (context, index) {
        return getAndReload(context, 'view/module/additem', { index: index });
    };
    /**
...
var QuickDialogManagerSingleton = /** @class */ (function (_super) {
    ...
    QuickDialogManagerSingleton.prototype.setUrlToQuickDialog = function (url) {
        ...
        url = url
            .replace(_constants__WEBPACK_IMPORTED_MODULE_1__["C"].DialogPaths.ng1, _constants__WEBPACK_IMPORTED_MODULE_1__["C"].DialogPaths.quickDialog)
