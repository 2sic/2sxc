...
* Any object can have a property - usually called `Log` which is an @ToSic.Eav.Logging.ILog .  
...
* Most objects which use the Log, implement the @ToSic.Eav.Logging.IHasLog, often by inheriting  
	@ToSic.Eav.Logging.HasLog which automates things when initializing - like the chaining of the Loggers. 
