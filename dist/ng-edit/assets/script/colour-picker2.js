(function () {
    ...
    class customColorPicker2 {
        ...
        render(container) {
            container.innerHTML = `<input id="color2" type="color"></input>`;
    ...
    function externalComponent2Factory(name) {
        ...
        return new customColorPicker2(name, null, null);
    }

    window.addOn.register(externalComponent2Factory('colour-picker2'));
})();