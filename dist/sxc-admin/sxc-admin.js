...
(function() { // TN: this is a helper construct, research iife or read https://github.com/johnpapa/angularjs-styleguide#iife
  ...
  AppSettingsController.$inject = ["appSettings", "appId", "eavAdminDialogs"];
  ...
  /*@ngInject*/
  function AppSettingsController(appSettings, appId, eavAdminDialogs) {
    var vm = this;
    ...
    vm.permissions = function permissions() {
      var metaApp = 3;
      return eavAdminDialogs.openPermissions(appId, metaApp, 'number', appId);
    };
