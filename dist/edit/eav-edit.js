...
angular.module("eavFieldTemplates")
    .config(["formlyConfigProvider", "defaultFieldWrappers", function (formlyConfigProvider, defaultFieldWrappers) {
        ...
        formlyConfigProvider.setType({
            ...
            wrapper: defaultFieldWrappers
                .slice(0)   // copy the array
                .splice(defaultFieldWrappers.indexOf("eavLocalization", 1)), // remove the localization...//["eavLabel", "bootstrapHasError", "collapsible"],
