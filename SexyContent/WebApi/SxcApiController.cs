        ...
        private AppAndDataHelpers AppAndDataHelpers {
            get
            {
                if (_appAndDataHelpers == null)
                {
                    ...
                    var viewDataSource = Sexy.GetViewDataSource(Request.FindModuleId(), SexyContent.HasEditPermission(moduleInfo), Sexy.ContentGroups.GetContentGroup(Sexy.ContentGroups.GetContentGroupIdFromModule(moduleInfo.ModuleID, Sexy)).Template);
