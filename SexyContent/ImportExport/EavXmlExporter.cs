...
namespace ToSic.SexyContent.ImportExport
{
    ...
    public class EavXmlExporter
    {
        // initialize data context
        private App _app;
        private EavDataController _eavAppContext;
        ...
        public EavXmlExporter(int zoneId, int appId, bool appExport, string[] attrSetIds, string[] entityIds)
        {
        ...
        protected void Constructor(int zoneId, int appId, bool appExport, string[] attrSetIds, string[] entityIds)
        {
            _isAppExport = appExport;
            //Sexy = new SxcInstance(_zoneId, _appId);
            _app = new App(zoneId, appId, PortalSettings.Current);
