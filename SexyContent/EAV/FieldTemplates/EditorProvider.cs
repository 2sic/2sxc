...
namespace ToSic.SexyContent.EAV.FieldTemplates
{
    public class EditorProvider : HtmlEditorProvider
    {
        ...
        public override void Initialize()
        {
            ...
            //_editor.EnableEmbeddedBaseStylesheet = false;
            //_editor.EnableEmbeddedSkins = false;
            //_editor.DialogOpener.EnableEmbeddedBaseStylesheet = true;
            //_editor.DialogOpener.EnableEmbeddedSkins = true;
            //_editor.DialogOpener.EnableTelerikManagers = true;
            //_editor.DialogsCssFile = moduleFolderPath + "/Css/Widgets.css";
        ...
        public readonly RadEditor _editor = new RadEditor();
